...
@ContextConfiguration(classes = ApplicationContextConfigurationForTestingFaceLoginServiceImpl.class)
public class FaceLoginServiceImplTest {
	...
	private void testLogin(String body, int expectedStatusCode, String expectedMsg) {
		...
		ResponseWrapper responseWrapper = faceLoginService.login(inputStream);
